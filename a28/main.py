...
CHARGE_VOLTAGE = 0
SPMI_SLAVE_ID = 0x03 #
PATH=r'C:\Users\JRedhair\Documents\BC95_Efficiency\A26'
CSV_HEADERS = ["timestamp", "ibatt", "vbatt"]

WCIN_ILIMS = [0x03, 0x13, 0x28, 0x4F, 0x77] # 0.1, 0.5, 1, 2, 3
VBAT_VALS = [3, 3.6, 4.2, 5.53]
VWCIN = 15.5
...
def read_all_data(csv_writer, instruments: list[Instrument]):
...
def setup_max77795(wcin_ilim: int):
    # ----------------------------
